...
public class StaticResourceConfiguration {
	...
	public SimpleUrlHandlerMapping staticResourceHandlerMapping() {
		...
		mapping.setUrlMap(Collections.singletonMap("/text/**", staticResourceRequestHandler()));
		return mapping;
	}
	...
	protected ResourceHttpRequestHandler staticResourceRequestHandler() {
		...
		ClassPathResource classPathResource = new ClassPathResource("static-mapping/text/");
